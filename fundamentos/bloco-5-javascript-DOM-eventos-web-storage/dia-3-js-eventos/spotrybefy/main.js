...
input2.addEventListener('input', alteraInput2)

function alteraInput2 (event) {
    const techElement2 = document.querySelectorAll('.tech')[1];
    techElement2.innerText = event.target.value
}
...
function abreLink () {
    window.location.replace('https://eliasef.github.io/')
}
